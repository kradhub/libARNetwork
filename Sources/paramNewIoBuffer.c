...
#define NETWORK_IOBUFFER_ACKTILEOUTMS_DEFAULT NETWORK_IOBUFFER_INFINITE_NUMBER
#define NETWORK_IOBUFFER_NBOFRETRY_DEFAULT NETWORK_IOBUFFER_INFINITE_NUMBER
